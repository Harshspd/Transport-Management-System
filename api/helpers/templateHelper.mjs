...
import { formatDate } from './utililty.mjs';
...
export const getTemplate = (data, htmlTemplatePath) => {
...
export const generatePdf = (replacedHtml, invoice) => {
  const pdfOptions = {
    format: 'A4',
    border: {
      top: '10px',
...
export const generatePdfBufferByHTML = async (uploadFolder, htmlString, pdfFileName) => {
...
export const getEstimateData = async (id) => {
  try {
