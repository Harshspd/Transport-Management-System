...
import { signin, signup, generateOTP, changePassword, unlockAccount, changeAccountEmail,registerUserUnderOrg, } from '../controllers/authController.js';
...
router.post('/register-under-org', authCheck, registerUserUnderOrg);
